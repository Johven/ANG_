...
"""Verify that starting angcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start angcoin with -h for help text")
        ...
        self.log.info("Start angcoin with -version for version information")
        ...
        self.log.info("Start angcoind with -fakearg to make sure it does not start")
