...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " angcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  angcoin-tx [options] <hex-tx> [commands]  Update hex-encoded angcoin transaction\n" +
            "or:     angcoin-tx [options] -create [commands]   Create hex-encoded angcoin transaction\n" +
            "\n";
