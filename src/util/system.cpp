...
const char * const BITCOIN_CONF_FILENAME = "angcoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "ANGCOIN";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/ANGCOIN";
#else
    // Unix
    return pathRet / ".angcoin";
#endif
#endif
}
