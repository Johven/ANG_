# Support for Output Descriptors in ANGCOIN Core

Since ANGCOIN Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `ang1...` for mainnet or `tang1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on ANGCOIN's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing ANGCOIN Core wallets, a convenience function `combo` is
